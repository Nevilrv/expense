...
import 'package:expense/Controller/AddDocumentsController/diploma_certificates_controller.dart';
...
class AddDiplomaCertificates extends StatefulWidget {
  const AddDiplomaCertificates({
    Key? key,
  }) : super(key: key);

  @override
  State<AddDiplomaCertificates> createState() => _AddDiplomaCertificatesState();
}

class _AddDiplomaCertificatesState extends State<AddDiplomaCertificates> {
  DiplomaCertificatesController diplomaCertificatesController =
      Get.put(DiplomaCertificatesController());

  @override
  Widget build(BuildContext context) {
    final size = MediaQuery.of(context).size;
    return GetBuilder<DiplomaCertificatesController>(
      builder: (controller) {
        return SafeArea(
          child: Scaffold(
