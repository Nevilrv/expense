...
import 'package:expense/View/Documents/Non-Mandatory/custom_document_screen.dart';
                ...
                overlay: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text('Select which document you would like to add',
                    ...
                    Container(
                      ...
                      margin:
                          EdgeInsets.symmetric(horizontal: size.height * 0.017),
                        ...
                        tabs: [
                          Center(
                            child: Text(
                              'Mandatory',
                              style:
                                  TextStyleHelper.kPrimary20W600Inter.copyWith(
                                fontSize: 14,
                                color: index == 0
